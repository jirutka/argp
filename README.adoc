...
* Small size overhead – ~60 kiB, that’s *10x less* than https://github.com/clap-rs/clap[clap] or https://github.com/clap-rs/clap/tree/master/clap_derive[clap_derive]! See https://github.com/rosetta-rs/argparse-rosetta-rs[argparse-rosetta-rs] for more details.
